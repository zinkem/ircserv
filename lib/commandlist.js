...
CommandList.prototype.MODE = function (user, args) {
  ...
  */
  ...
  if (this.channels[chan]) return this.configModeChannel(user, chan, flags, params);
...
CommandList.prototype.INVITE = function (user, args) {
  ...
  */
  ...
  if (this.users[nick].this.channels[chan]) {
  ...
  if (query_string && this.channels[chan_id]) {
    this.channels[chan_id]._readableState.pipes
      ...
      .forEach((listener) => {
        ...
        if (ops_flag && !this.channels[chan_id].mode.o[member.nick]) return;
